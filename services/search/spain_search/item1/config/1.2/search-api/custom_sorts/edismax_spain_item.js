...
function expand_qf_service(req) {
    ...
    var qf = "base_sku^0.08 sku^0.08 shop_name^0.9 item_name^1.8 description^0.06 size^0.1 color^0.1 variant_names^0.1 variant_values^0.1 brand^0.2 skus^0.09 tag_line^0.09 _query_boost_terms_exact^0.04";
...
function expand_qf_service_nosqip(req) {
    ...
    var qf = "base_sku^0.08 sku^0.08 shop_name^0.9 item_name^1.8 description^0.06 size^0.1 color^0.1 variant_names^0.1 variant_values^0.1 brand^0.2 skus^0.09 tag_line^0.09";
